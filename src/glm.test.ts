...
it('should match expected interface', () => {
    ...
    expect(glm).toHaveProperty('transposeMatrix2')
    expect(glm).toHaveProperty('transposeMatrix3')
    ...
    expect(glm).toHaveProperty('multiplyNumberMatrix3')
    ...
    expect(glm).toHaveProperty('multiplyMatrix3Number')
    expect(glm).toHaveProperty('multiplyMatrix3Vector3')
    expect(glm).toHaveProperty('multiplyMatrix3Matrix3')
